...
description: About page for my technical blog. Behind the scene technical insight.
---
...
Inline-style:
![alt text](/assets/images/posts/random-icon.png 'Logo Title Text 1')

Reference-style:
![alt text][logo]

[logo]: /assets/images/posts/random-icon.png 'Logo Title Text 2'
